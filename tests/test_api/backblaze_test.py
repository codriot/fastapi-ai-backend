...
PUBLIC_BUCKET_NAME = settings.BACKBLAZE_BUCKET_NAME  # Ana bucket

file1 = "test_image.jpg"  # Test için örnek dosya
LOCAL_DIR = os.path.join(os.path.dirname(__file__), 'test_files')  # Test dosyaları için klasör

# Test dosyaları klasörünü oluştur
